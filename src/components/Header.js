...
const Header = () => {
  return (
    <>
      <nav class="bg-white h-[3.75rem] w-full">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-end">
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4 w-[55.3125rem] sm-width-auto shrink">
                  ...
                  <a
                    href="/"
                    class="flex-1 shrink relative leading-[1.38rem] text-[rgba(87,87,87)] font-poppins leading-6 text-[1.5rem]  flex justify-center"
                  >
                    Home
                  </a>
