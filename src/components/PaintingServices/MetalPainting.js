  ...
  return (
    <div>
      <nav
        ...
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/drjnmxyd5/image/upload/v1677215207/unsplash_9M66C_w_ToM_5_seelhj.png)",
        }}
      >
        ...
        <div className="h-[30.6875rem] w-[77.585625rem] m-auto flex items-center justify-between">
          <div className="w-[51.58375rem] h-[24.375rem]">
            ...
            <p className="text-[1.125rem] font-poppins font-normal leading-[1.75rem] mt-[1.438125rem]">
              metal Painting is different than painting other surfaces, and the
              material is challenging to work with. Paint doesn’t stick as well
              to a metal surface as it does to wood or plaster. Also, metal is
              prone to oxidation and rust. When painting on metal, it’s
              essential to use a paint formulated for metal, especially if you
              want to control rust and weathering. so that time we are helping
              <br />
              Spray Painting -can paint offers the easiest way to paint metal.
              It is especially useful for pieces that have many contours, such
              as patio furniture or wrought-iron fences or railings. But the
              finish is usually not as smooth and uniform as with brush-on
              paint, and it may take several coats to achieve the desired
              finish.
              <br />
              Brush-on paint takes considerably longer to apply, but the finish
              will be smooth and durable. Both water-based and oil-based
