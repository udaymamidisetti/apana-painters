  ...
  return (
    <div>
      <nav
        ...
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/drjnmxyd5/image/upload/v1677215094/unsplash_9M66C_w_ToM_4_msnb8v.png)",
        }}
      >
        ...
        <div className="h-[30.6875rem] w-[77.585625rem] m-auto flex items-center justify-between">
          <div className="w-[51.58375rem] h-[24.375rem]">
            ...
            <p className="text-[1.125rem] font-poppins font-normal leading-[1.75rem] mt-[1.438125rem]">
              Improve Your Wood Quality and Look With The Help of Apna Painter
              Wood is an excellent material for home décor, but it requires
              periodic maintenance to keep its natural look. Wood painting is
              the best way to protect your wood from stains and scratches.
              Whether you are planning on painting your living room or dining
              space, there is something for everyone. Whether you need a natural
              color to accent with the wood accents in your home or office, or
              if you want a sophisticated and elegant look, Apna painter has the
              perfect Wood coating services for your wood we are Helping For
              More and more long life
            </p>
          </div>
