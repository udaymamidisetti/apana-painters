  ...
  return (
    <div>
      <nav
        ...
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/drjnmxyd5/image/upload/v1677173612/unsplash_9M66C_w_ToM_1_weg9cb.png)",
        }}
      >
        ...
        <div className="h-[30.6875rem] w-[77.585625rem] m-auto flex items-center justify-between">
          <div className="w-[51.58375rem] h-[24.375rem]">
            ...
            <p className="text-[1.125rem] font-poppins font-normal leading-[1.75rem] mt-[1.438125rem]">
              First our expert team does an inspection of the workplace then
              Surface preparation, including cleaning and repairing any cracks
              or damage to the surface Application of high-quality waterproofing
              products specifically designed for your type of surface Options
              for color matching and custom finish to enhance the appearance of
              your space Expert advice and guidance on the most suitable
              waterproofing solution for your specific needs and conditions
              Experienced and skilled professionals with a focus on providing
