  ...
  return (
    <div>
      ...
      <nav
        ...
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/drjnmxyd5/image/upload/v1677214894/unsplash_9M66C_w_ToM_3_fzyh4w.png)",
        }}
      >
        ...
        <div className="h-[30.6875rem] w-[77.585625rem] m-auto flex items-center justify-between">
          <div className="w-[51.58375rem] h-[24.375rem]">
            ...
            <p className="text-[1.125rem] font-poppins font-normal leading-[1.75rem] mt-[1.438125rem]">
              Wall texture refers to the surface quality and appearance of a
              wall, such as its roughness, smoothness, or pattern. This can be
              achieved through various methods, including the use of textured
              paint, wallpaper, or other decorative finishes. The choice of wall
              texture can greatly impact the overall look and feel of a room,
              and can help to add interest, depth, and
              dimension to your walls.Professional preparation of surfaces to be
              painted, including cleaning, sanding, and filling in cracks and
              holes Careful masking and protection of non-painted areas to
              minimize mess and ensure clean lines Thorough clean-up after the
              job is done Experienced and skilled painters with attention to
              detail Options for color consultation and color matching to help
              you choose the right shade for your space
            </p>
          </div>
