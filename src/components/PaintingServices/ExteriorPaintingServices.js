  ...
  return (
    <div>
      <nav
        ...
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/drjnmxyd5/image/upload/v1677156567/unsplash_9M66C_w_ToM_irzqp9.svg)",
        }}
      >
      ...
      <div className="w-full h-[57.625rem] mt-[3.75rem]">
        <div className="h-[30.6875rem] w-[77.585625rem] m-auto flex items-center justify-between">
          <div className="w-[51.58375rem] h-[24.375rem]">
            ...
            <p className="text-[1.125rem] font-poppins font-normal leading-[1.75rem] mt-[1.438125rem]">
              we have High-quality paint from well-known brands and We are using
              Automatic tools for Outdoor wall washing .Thorough preparation of
              surfaces to be painted, including pressure washing, scraping,
              sanding, and filling in cracks and holes Careful masking and
              protection of non-painted areas to minimize mess and ensure clean
              lines Use of proper techniques and equipment to ensure a smooth
              and even finish Options for color consultation and color matching
              to help you choose the right shade for your home's exterior
              Experienced and skilled painters with attention to detail and an
              eye for aesthetics Flexible scheduling to accommodate your needs
            </p>
          </div>
        ...
        <div className="w-[77.5rem] h-[26.9375rem]  m-auto">
          <h1 className="font-bold text-center text-[2rem] h-[3.625rem]">
            Recent Project Exterior Painting
          </h1>
